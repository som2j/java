...
public class B_상수 {
	...
	public static void main(String[] args) {
		...
		//		camelCasd : 이름을 지을 때 여러 단어를 결합해서 지을 경우 단어의 구분을 대문자로 구분하는 방식
		// 					ex) coffeePrice
		// 자바의 변수는 첫글자가 소문자여야 한다. 
		
		//클래스 표기법 : camelCase를 따르되, 제일 첫 글자가 대문자이다.
		
		//상수 표기법 : uppercase snake 표기법을 따른다.
		//				snake 표기법 : 이름을 지을 때 여러 단어를 결합해서 지을 경우, 단어의 구분을 _로 하는 방식
		//				ex) food_price
